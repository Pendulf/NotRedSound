...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  late final List<_OnboardingPageData> _pages = [
    _OnboardingPageData(
      ...
      title: 'Выберай стиль',
      description:
          'Стандартный, Рок, Электронный и Классический — это 4 отдельных проекта со своим оформлением и набором инструментов',
      hint: 'Свой стиль можно менять в настройках проекта надпись “Проект”',
    ...
    _OnboardingPageData(
      ...
      description:
          'Создавай и удаляй дорожки, переименовывай их, меняй громкость, активность и инструмент под нужный стиль и звучание',
      hint: 'У Рок, Электро и Классики уже есть стартовые подписанные дорожки',
    ...
    _OnboardingPageData(
      ...
      description:
          'Нажми на превью дорожки в нужном такте и открой редактор нот. Там можно записывать ноты голосом и затем редактировать их',
    ...
    _OnboardingPageData(
      ...
      description:
          'Запиши голос, запусти воспроизведение, добавь ещё ещё и ещё, а затем экспортируй проект в MIDI для дальнейшей доработки',
      hint: 'Данную подсказку повторно можно посмотреть при выборе стиля',
                  ...
                  Row(
                    children: [
                      TextButton(
                        onPressed: _finish,
                        child: Text(
                          widget.openLaunchAfterFinish ? 'Пропустить' : 'Закрыть',
                          style: TextStyle(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        _pageIndex == _pages.length - 1
                            ? (widget.openLaunchAfterFinish ? 'На экран выбора' : 'Готово')
                            : 'Далее',
                        style: const TextStyle(
                          fontSize: 17,
                          fontWeight: FontWeight.w800,
