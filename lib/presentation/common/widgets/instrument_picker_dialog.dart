...
class _InstrumentPickerDialogState extends State<_InstrumentPickerDialog> {
  ...
  void initState() {
    ...
    sections =
        AppConstants.currentStyle.instrumentCategories.entries.map((entry) {
  ...
  Widget build(BuildContext context) {
    ...
    final gridColumns = screenWidth < 360 ? 2 : 3;
        ...
        child: ClipRRect(
          ...
          child: ConstrainedBox(
            constraints: BoxConstraints(
              ...
              maxWidth: screenWidth < 520 ? screenWidth - 32 : 520,
            ),
            child: Column(
              children: [
                Container(
